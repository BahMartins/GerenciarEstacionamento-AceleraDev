 ...
 @Override
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withIdade(int idade) {
            ...
            if(idade < 0){
                throw new IllegalArgumentException("Idade do motorista inválida, não pode ser negativa");
            }
        ...
        public MotoristaBuilder withPontos(int pontos) {
            ...
            if(pontos < 0){
                throw new IllegalArgumentException("Quantidade de pontos inválida, a pontuação não pode ser negativa");
            }
        ...
        public Motorista build() {
            if(this.nome == null || this.habilitacao == null){
                throw new NullPointerException("Necessário informar o nome e os dados da habilitação do motorista");
            }
